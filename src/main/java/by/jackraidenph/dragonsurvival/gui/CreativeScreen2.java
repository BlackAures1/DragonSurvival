...
public class CreativeScreen2 extends DisplayEffectsScreen<CreativeScreen2.CreativeContainer> {
    ...
    public CreativeScreen2(PlayerEntity player) {
        super(new CreativeScreen2.CreativeContainer(player), player.inventory, new StringTextComponent(""));
    ...
    public void tick() {
        if (!this.minecraft.playerController.isInCreativeMode()) {
            this.minecraft.displayGuiScreen(new DragonInventoryScreen(this.minecraft.player));
        ...
        if (slotIn == null && selectedTabIndex != ItemGroup.INVENTORY.getIndex() && type != ClickType.QUICK_CRAFT) {
            ...
            if (slotIn == this.destroyItemSlot && flag) {
                ...
                if (slotIn == this.destroyItemSlot) {
                    ...
                    this.minecraft.playerController.sendSlotPacket(itemstack1, ((CreativeScreen2.CreativeSlot) slotIn).slot.slotNumber);
                    ...
                    this.minecraft.player.container.slotClick(slotIn == null ? slotId : ((CreativeScreen2.CreativeSlot) slotIn).slot.slotNumber, mouseButton, type, this.minecraft.player);
    ...
    private void setCurrentCreativeTab(ItemGroup tab) {
        ...
        if (tab == ItemGroup.INVENTORY) {
            ...
            for (int l = 0; l < container.inventorySlots.size(); ++l) {
                ...
                Slot slot = new CreativeScreen2.CreativeSlot(container.inventorySlots.get(l), l, i1, j1);
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        ...
        if (this.destroyItemSlot != null && selectedTabIndex == ItemGroup.INVENTORY.getIndex() && this.isPointInRegion(this.destroyItemSlot.xPos, this.destroyItemSlot.yPos, 16, 16, p_render_1_, p_render_2_)) {
    ...
    protected void renderTooltip(ItemStack p_renderTooltip_1_, int p_renderTooltip_2_, int p_renderTooltip_3_) {
        if (selectedTabIndex == ItemGroup.SEARCH.getIndex()) {
            ...
            for (int i = 0; i < list1.size(); ++i) {
                if (i == 0) {
                    list1.set(i, p_renderTooltip_1_.getRarity().color + list1.get(i));
                } else {
    ...
    public static class CreativeContainer extends Container {
        ...
        public CreativeContainer(PlayerEntity player) {
            ...
            for (int i = 0; i < 5; ++i) {
                for (int j = 0; j < 9; ++j) {
                    this.addSlot(new CreativeScreen2.LockedSlot(CreativeScreen2.TMP_INVENTORY, i * 9 + j, 9 + j * 18, 18 + i * 18));
                }
            }
            //hotbar
            for (int k = 0; k < 9; ++k) {
            ...
            for (int k = 0; k < 5; ++k) {
                for (int l = 0; l < 9; ++l) {
                    ...
                    if (i1 >= 0 && i1 < this.itemList.size()) {
                        CreativeScreen2.TMP_INVENTORY.setInventorySlotContents(l + k * 9, this.itemList.get(i1));
                    } else {
                        CreativeScreen2.TMP_INVENTORY.setInventorySlotContents(l + k * 9, ItemStack.EMPTY);
                    }
                }
            }
        ...
        public boolean canMergeSlot(ItemStack stack, Slot slotIn) {
            return slotIn.inventory != CreativeScreen2.TMP_INVENTORY;
        }
    ...
    static class CreativeSlot extends Slot {
        ...
        public CreativeSlot(Slot slot, int p_i229959_2_, int p_i229959_3_, int p_i229959_4_) {
            super(slot.inventory, p_i229959_2_, p_i229959_3_, p_i229959_4_);
            this.slot = slot;
        }
