...
public class BlockInit {
    ...
    public static void registerBlocks(final RegistryEvent.Register<Block> event) {
        ...
        dragonBeacon = registerBlock(new DragonBeacon(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(3, 50).harvestLevel(2).requiresCorrectToolForDrops().noOcclusion()), "empty_dragon_beacon", forgeRegistry);
        peaceDragonBeacon = registerBlock(new DragonBeacon(AbstractBlock.Properties.copy(dragonBeacon).lightLevel(value -> value.getValue(DragonBeacon.LIT) ? 15 : 0).noOcclusion()), "dragon_beacon_peace", forgeRegistry);
        magicDragonBeacon = registerBlock(new DragonBeacon(AbstractBlock.Properties.copy(dragonBeacon).lightLevel(value -> value.getValue(DragonBeacon.LIT) ? 15 : 0).noOcclusion()), "dragon_beacon_magic", forgeRegistry);
        vetoDragonBeacon = registerBlock(new DragonBeacon(AbstractBlock.Properties.copy(dragonBeacon).lightLevel(value -> value.getValue(DragonBeacon.LIT) ? 15 : 0).noOcclusion()), "dragon_beacon_veto", forgeRegistry);
