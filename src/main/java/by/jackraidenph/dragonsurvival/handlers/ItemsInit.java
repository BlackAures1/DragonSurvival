...
public class ItemsInit {
    ...
    public static void register(final RegistryEvent.Register<Item> event) {
        ...
        chargedCoal = new Item(new Item.Properties().group(BlockInit.blocks).food(new Food.Builder().hunger(5).saturation(7).build())).setRegistryName(DragonSurvivalMod.MODID, "charged_coal");
        charredMeat = new Item(new Item.Properties().group(BlockInit.blocks).food(new Food.Builder().hunger(10).saturation(13).build())).setRegistryName(DragonSurvivalMod.MODID, "charred_meat");
